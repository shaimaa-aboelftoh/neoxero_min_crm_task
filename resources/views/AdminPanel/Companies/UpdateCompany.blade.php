        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <p class="text-muted small m-b-30">يمكنك الإطلاع وتعديل بيانات الشركه</p>
                    <div class="row">
                        <div class="col-md-12">
                            {!! Form::open(['files'=>true,'url'=>url('/Companies/'.$company->id),'method'=>'post']) !!}
                            @method('PATCH')
                            @csrf
                            <div class="col-md-4">
                                <div class="form-group {{$errors->has('company_name') ? 'has-error' :''}}">
                                    <label class="control-label" for="company_name">إسم الشركه</label>
                                    {!! Form::text('company_name',$company->name,['id'=>'company_name','class'=>'form-control','placeholder'=>'']) !!}
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{$errors->has('email') ? 'has-error' :''}}">
                                    ...
                                    {!! Form::email('email',$company->email,['id'=>'email','class'=>'form-control','placeholder'=>'مثال : name@domain.com']) !!}
                                    @if($errors->has('email'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{$errors->has('company_website') ? 'has-error' :''}}">
                                    ...
                                    {!! Form::text('company_website',$company->website,['id'=>'company_website','class'=>'form-control','placeholder'=>'مثال : http://neoxero.com']) !!}
