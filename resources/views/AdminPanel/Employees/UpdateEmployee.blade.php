        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <p class="text-muted small m-b-30">يمكنك الإطلاع وتعديل بيانات الموظف</p>
                    <div class="row">
                        <div class="col-md-12">
                            {!! Form::open(['files'=>true,'url'=>url('/Employees/'.$employee->id),'method'=>'post']) !!}
                            @method('PUT')
                            @csrf
                            <div class="col-md-2">
                                <div class="form-group {{$errors->has('firstName') ? 'has-error' :''}}">
                                    <label class="control-label" for="firstName">الإسم الأول</label>
                                    {!! Form::text('firstName',$employee->firstName,['id'=>'firstName','class'=>'form-control','placeholder'=>'']) !!}
                            ...
                            <div class="col-md-2">
                                <div class="form-group {{$errors->has('lastName') ? 'has-error' :''}}">
                                    ...
                                    {!! Form::text('lastName',$employee->lastName,['id'=>'lastName','class'=>'form-control','placeholder'=>'']) !!}
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{$errors->has('email') ? 'has-error' :''}}">
                                    ...
                                    {!! Form::email('email',$employee->email,['id'=>'email','class'=>'form-control','placeholder'=>'مثال : name@domain.com']) !!}
                                    @if($errors->has('email'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{$errors->has('phone') ? 'has-error' :''}}">
                                    ...
                                    {!! Form::text('phone',$employee->phone,['id'=>'phone','class'=>'form-control','placeholder'=>'مثال : 01001001001']) !!}
                                    @if($errors->has('phone'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{$errors->has('company_id') ? 'has-error' :''}}">
                                    ...
                                    {!! Form::select('company_id',$select_company,$employee->company_id,['id'=>'company_id','class'=>'form-control']) !!}
