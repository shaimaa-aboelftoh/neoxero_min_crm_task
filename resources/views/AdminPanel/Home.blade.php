                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table table-hover m-0">
                                ...
                                <tr>
                                    <th>
                                        <img src="{{url('/')}}/ProjectAttachments/AdminAssets/assets/images/users/avatar-1.jpg" alt="user" class="thumb-sm img-circle" />
                                    </th>
                                    <td>
                                ...
                                <tr>
                                    <th>
                                        <img src="{{url('/')}}/ProjectAttachments/AdminAssets/assets/images/users/avatar-2.jpg" alt="user" class="thumb-sm img-circle" />
                                    </th>
                                    <td>
                                ...
                                <tr>
                                    <th>
                                        <img src="{{url('/')}}/ProjectAttachments/AdminAssets/assets/images/users/avatar-3.jpg" alt="user" class="thumb-sm img-circle" />
                                    </th>
                                    <td>
                                ...
                                <tr>
                                    <th>
                                        <img src="{{url('/')}}/ProjectAttachments/AdminAssets/assets/images/users/avatar-4.jpg" alt="user" class="thumb-sm img-circle" />
                                    </th>
                                    <td>
                                ...
                                <tr>
                                    <th>
                                        <img src="{{url('/')}}/ProjectAttachments/AdminAssets/assets/images/users/avatar-5.jpg" alt="user" class="thumb-sm img-circle" />
                                    </th>
                                    <td>
